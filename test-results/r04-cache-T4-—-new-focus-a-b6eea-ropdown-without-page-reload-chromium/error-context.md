...
- Location: tests/r04-cache.spec.ts:148:5
...
Call log:
  - waiting for locator('#creation-modal-create-close')
    - locator resolved to <button class="cm-btn cm-btn-secondary" id="creation-modal-create-close">Create & Close</button>
...
- generic [ref=e1]:
  ...
  - dialog [ref=e34]:
    ...
    - generic [ref=e38]:
      - tab "Focus" [selected] [ref=e39] [cursor=pointer]
      - tab "Sub-Focus" [ref=e40] [cursor=pointer]
      - tab "Epic" [ref=e41] [cursor=pointer]
      - tab "Story" [ref=e42] [cursor=pointer]
    - generic [ref=e43]:
      - generic [ref=e44]:
        - generic [ref=e45]: Focus Name *
        - textbox "Focus Name *" [active] [ref=e46]:
          - /placeholder: e.g., Health & Fitness
          - text: PW01-T4-focus-1781913155306
        - generic [ref=e47]: Top-level area of focus
      - generic [ref=e48]:
        - generic [ref=e49]: Color
        - textbox "Color" [ref=e50] [cursor=pointer]: "#007bff"
    - generic [ref=e51]:
      - button "Cancel" [ref=e52] [cursor=pointer]
      - button "Create and close modal" [ref=e53] [cursor=pointer]: Create & Close
      - button "Create and add another item" [ref=e54] [cursor=pointer]: Create & Add Another
```
